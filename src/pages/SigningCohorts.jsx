...
const SigningCohorts = () => {
      ...
      try {
        ...
        const transformedCohorts = cohortsData.map((cohort) => {
          ...
          return {
            ...
            hasClone: !!cohort.multisigAddress || !!cohort.multisig,
            // Policy data
  ...
  const sortedCohorts = [...cohorts].sort((a, b) => {
    ...
    if (sortBy === 'hasClone') {
      return sortOrder === 'asc' ? (a.hasClone ? 1 : 0) - (b.hasClone ? 1 : 0) : (b.hasClone ? 1 : 0) - (a.hasClone ? 1 : 0);
    }
    const aVal = a[sortBy];
    const bVal = b[sortBy];
    ...
    <div className={styles.signingCohorts}>
      <div className={styles.container}>
        <PageHeader
          ...
          subtitle="Threshold signing cohorts for on-chain action execution"
          stats={[
          ...
          <table className={styles.table}>
            <thead>
              <tr>
                ...
                <th onClick={() => handleSort('hasClone')} className={styles.sortable}>
                  Clone{sortIndicator('hasClone')}
                </th>
                ...
                >
                  ...
                  <td className={styles.nodesCell}>
                    ...
                    <span className={styles.chainIcons}>
                      ...
                      <ChainIcon chainId={cohort.chainId || '1'} size={14} showLabel />
                    </span>
                  </td>
                  ...
                  <td className={styles.numericCell}>
                    {cohort.hasClone ? (
                      <span className={styles.cloneBadge}>EIP-1271</span>
                    ) : (
